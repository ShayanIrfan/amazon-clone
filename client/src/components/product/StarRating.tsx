...
export default function StarRating({ rating, count, size = 14 }: Props) {
  ...
  return (
    <div className="flex items-center gap-1">
      <div className="flex text-amazon-orange" aria-label={`${rating.toFixed(1)} out of 5 stars`}>
      ...
      {count != null && (
        <span className="text-xs text-link hover:text-amazon-orange hover:underline">
